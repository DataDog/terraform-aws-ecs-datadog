...
| <a name="input_dd_manage_task_role_permissions"></a> [dd\_manage\_task\_role\_permissions](#input\_dd\_manage\_task\_role\_permissions) | Whether to create and attach permissions to the task role. Set to false if your task role already has the necessary permissions. | `bool` | `true` | no |
